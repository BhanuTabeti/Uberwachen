...
public class Sheet1Schema3Item implements Parcelable, IdentifiableBean {
    ...
    public static final Creator<Sheet1Schema3Item> CREATOR = new Creator<Sheet1Schema3Item>() {
        @Override
        public Sheet1Schema3Item createFromParcel(Parcel in) {
            Sheet1Schema3Item item = new Sheet1Schema3Item();
        ...
        @Override
        public Sheet1Schema3Item[] newArray(int size) {
            return new Sheet1Schema3Item[size];
        }
    };
