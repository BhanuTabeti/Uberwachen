...
public class Sheet1Schema4Item implements Parcelable, IdentifiableBean {
    ...
    @SerializedName("aa") public String aa;
    ...
    public static final Creator<Sheet1Schema4Item> CREATOR = new Creator<Sheet1Schema4Item>() {
        @Override
        public Sheet1Schema4Item createFromParcel(Parcel in) {
            Sheet1Schema4Item item = new Sheet1Schema4Item();
            ...
            item.aa = in.readString();
            return item;
        }

        @Override
        public Sheet1Schema4Item[] newArray(int size) {
            return new Sheet1Schema4Item[size];
        }
    };
